...
plot_o1a_data <- readRDS(file = ".../plot_o1a.rds")
plot_o1b_data <- readRDS(file = ".../plot_o1b.rds")
plot_o2_data <- readRDS(file = ".../plot_o2.rds")
plot_o3a_data <- readRDS(file = ".../plot_o3a.rds")
plot_o3b_data <- readRDS(file = ".../plot_o3b.rds")
